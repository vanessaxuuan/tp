...
| **GITHUB**         | May only contain alphanumeric, characters or hyphens but must not have multiple consecutive hyphens and cannot begin or end with a hyphen. It can either be blank or only have a maximum of 39 characters and minimum of 2 characters. <br> e.g. `12345678` or `cake-is-a-lie77`
