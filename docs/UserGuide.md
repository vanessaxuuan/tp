...
| **TUTORIAL_GROUP** | Must start with a valid module code, followed by a space, then a word that can contain letters, numbers, underscores and hyphens. It can **NEVER** be empty. The tutorial name can be a single digit (1 - 9) or alphanumeric characters but it cannot end or start with a hyphen. A tutorial group can only have a maximum of 100 characters including whitespace. <br> e.g. `CS2103T W15-3_A`                                                                                                                                                                                                                                                                                                                                                      |
