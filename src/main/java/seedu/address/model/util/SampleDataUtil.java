...
public class SampleDataUtil {
    public static Person[] getSamplePersons() {
        return new Person[] {
            new Person(new Name("Alex Yeoh"), new TelegramHandle("87438807"),
                new Email("alexyeoh@example.com"), new GitHub("Blk 30 Geylang Street 29, #06-40")),
            new Person(new Name("Bernice Yu"), new TelegramHandle("99272758"),
            ...
            new Person(new Name("David Li"), new TelegramHandle("91031282"),
                new Email("lidavid@example.com"), new GitHub("Blk 436 Serangoon Gardens Street 26, #16-43")),
            new Person(new Name("Irfan Ibrahim"), new TelegramHandle("92492021"),
                new Email("irfan@example.com"), new GitHub("Blk 47 Tampines Street 20, #17-35")),
            new Person(new Name("Roy Balakrishnan"), new TelegramHandle("92624417"),
